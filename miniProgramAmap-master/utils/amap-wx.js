...
AMapWX.prototype.getWxLocation = function (a, b) {
  ...
  AMapWX.prototype.getRegeo = function (a) {
    function c(c) {
      ...
      wx.request({
        url: "http://127.0.0.1:88/kading/v3/geocode/regeo",
        data: {
          key: b.key,
          location: c,
          extensions: "all",
  ...
  AMapWX.prototype.getWeather = function (a) {
    function d(d) {
      ...
      a.type && "forecast" == a.type && (e = "all"),
        wx.request({
          url: "http://127.0.0.1:88/kading/v3/weather/weatherInfo",
          data: {
            key: b.key,
            city: d,
            extensions: e,
  ...
  AMapWX.prototype.getPoiAround = function (a) {
    function d(d) {
      ...
      a.querytypes && (e["types"] = a.querytypes),
        ...
        wx.request({
          url: "http://127.0.0.1:88/kading/v3/place/around",
          data: e,
          method: "GET",
          header: {
            "content-type": "application/json"
  ...
  AMapWX.prototype.getStaticmap = function (a) {
    ...
    var e, b = this,
      c = [],
      d = "http://127.0.0.1:88/kading/v3/staticmap?";
    c.push("key=" + b.key),
      e = b.requestConfig,
      c.push("s=" + e.s),
  ...
  AMapWX.prototype.getInputtips = function (a) {
    ...
    a.location && (d["location"] = a.location),
      ...
      wx.request({
        url: "http://127.0.0.1:88/kading/v3/assistant/inputtips",
        data: d,
        method: "GET",
        header: {
          "content-type": "application/json"
  ...
  AMapWX.prototype.getDrivingRoute = function (a) {
    ...
    a.origin && (d["origin"] = a.origin),
      ...
      wx.request({
        url: "http://127.0.0.1:88/kading/v3/direction/driving",
        data: d,
        method: "GET",
        header: {
          "content-type": "application/json"
  ...
  AMapWX.prototype.getWalkingRoute = function (a) {
    ...
    a.origin && (d["origin"] = a.origin),
      a.destination && (d["destination"] = a.destination),
      wx.request({
        url: "http://127.0.0.1:88/kading/v3/direction/walking",
        data: d,
        method: "GET",
        header: {
          "content-type": "application/json"
  ...
  AMapWX.prototype.getTransitRoute = function (a) {
    ...
    a.origin && (d["origin"] = a.origin),
      ...
      wx.request({
        url: "http://127.0.0.1:88/kading/v3/direction/transit/integrated",
        data: d,
        method: "GET",
        header: {
          "content-type": "application/json"
  ...
  AMapWX.prototype.getRidingRoute = function (a) {
    ...
    a.origin && (d["origin"] = a.origin),
      a.destination && (d["destination"] = a.destination),
      wx.request({
        url: "http://127.0.0.1:88/kading/v4/direction/bicycling",
        data: d,
        method: "GET",
        header: {
          "content-type": "application/json"
