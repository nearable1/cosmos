		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate(":text, [type='password'], [type='file'], select, textarea, " +
					...
					"focusin focusout change keyup", delegate)
...
jQuery.validator.addMethod("phone", function(value, element) {
	return this.optional(element) || /^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})(\-[0-9]{1,4})?$/.test(value) || /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/.test(value);
}, "请正确填写您的固定电话或手机号码");	
