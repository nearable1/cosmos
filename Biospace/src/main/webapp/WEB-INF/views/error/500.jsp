...
if (Servlets.isAjaxRequest(request)) {
	// yangj 2017.9.10 start
	// out.print(sb);
	String message = "系统内部错误.";
	if (ex instanceof com.inbody.crm.common.service.ServiceException) {
...
<%@page import="com.inbody.crm.common.web.Servlets"%>
<%@page import="com.inbody.crm.common.utils.Exceptions"%>
<%@page import="com.inbody.crm.common.utils.StringUtils"%>
