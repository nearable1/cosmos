...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            if(n) $("#pageNo").val(n);
            if(s) $("#pageSize").val(s);
            $("#searchForm").attr("action", "${ctx}/pm/purchase/ac/list");
            $("#searchForm").submit();
            return false;
        }
    </script>
...
<body>
    <h3 class="text-center page-title">配件采购订单查询</h3>
    <form:form id="searchForm" modelAttribute="searchForm" action="${ctx}/pm/purchase/ac/list" method="get" class="breadcrumb form-search">
        ...
        <ul class="ul-form">
            ...
            <li class="btns">
                ...
                <input class="btn btn-primary" type="button" value="清空" onclick="javascript:window.location.href='${ctx}/pm/purchase/ac/list';">
                <input id="export" class="btn btn-primary" type="submit" value="一览导出" onclick="javascript:this.form.action='${ctx}/pm/purchase/ac/list/export';">
            </li>
        </ul>
    </form:form>
