	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			/*  $("#addRowInfo").on("click",function(){
	        		...
	        		html += '<td><input name="eeEmpPlans[0].displayItem2" type="text" style="width: 150px;"/></td>';
	        		html += '<td><input name="eeEmpPlans[0].displayItem3" type="text" style="width: 150px;"/></td>';
	        		html += '<td><input name="eeEmpPlans[0].displayItem4" type="text" style="width: 150px;"/></td>';
	        		html += '<td><input name="eeEmpPlans[0].displayItem5" type="text" style="width: 250px;"/></td>';
	        		html += '</tr>';
...
<body>
	...
	<sys:message content="${message}"/>
	 <%-- <form id="searchForm" action="${ctx}/ee/eeSaleEmp/" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
		<li><label style="display: inline-block;width: 80px;">业务评价：</label>
			<input name="year" type="text" id="year" value="${eeSaleEmp.year }" readonly="readonly" style="width: 100px"
			 class="input-mini required Wdate"/>
		</li>
    ...
    <div class="group-box">
 	...
 	<c:if test="${eeSaleEmp.workflowStatus != 50}">
	    <div class="group-box">
	         <div class="group-header" >
	         ...
	         <textarea rows="2" maxlength="1000" name="eeEmpEvaluations[0].describe1" cols="200" style="width:500px;">${evaluationBean2.describe1 }</textarea><br>
	         2. 请具体描述该组员在本年做的不足的地方.<br>
	         <textarea rows="2" maxlength="1000" name="eeEmpEvaluations[0].describe2" cols="200" style="width:500px;">${evaluationBean2.describe2 }</textarea><br>
	         3.请描述该组员在业务上的长处、特点以及可能性.<br>
	         <textarea rows="2" maxlength="1000" name="eeEmpEvaluations[0].describe3" cols="200" style="width:500px;">${evaluationBean2.describe3 }</textarea><br>
	         4. 请描述该组员在工作上的短处以及问题点. <br>
	         <textarea rows="2" maxlength="1000" name="eeEmpEvaluations[0].describe4" cols="200" <%-- readonly="${viewsts.canEdit ? true:false}"  --%>style="width:500px;">${evaluationBean2.describe4 }</textarea><br>
			...
			<table id="tableHead" style="width:100%" class="table table-striped table-bordered table-condensed" >
				...
				<tbody>
					<tr>
						<td>工作成果量</td><td>工作效率, 工作的产出/成果量</td>
						<td><input type="hidden" name="eeEmpEvaluations[0].evaluateType" value="2" />
						<input type="hidden" name="eeEmpEvaluations[0].id" value="${evaluationBean2.id }" />
							<select name="eeEmpEvaluations[0].evaluate1" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>工作质量</td><td>工作完成的精准度,工作成果的质量是否优秀</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate2"  class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>业务知识</td><td>是否清楚本人所要做的工作内容以及为什么要做?</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate3" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						...
						<td>
							<select name="eeEmpEvaluations[0].evaluate4" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>工作信任度</td><td>是否值得信任，是否能扎实地完成本人的工作任务</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate5" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>创意力</td><td>在工作的同时是否会主动思考更好的工作方法，和有创意性的改善工作的方法</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate6" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>协作精神</td><td>对于同事的请求乐于帮助、解决，与其他同事相互配合默契</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate7" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>考勤情况</td><td>无迟到早退现象，工作时间集中度高</td>
						<td>
							<select name="eeEmpEvaluations[0].evaluate8" class="zzEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
			...
			<div>
			<label style="float: right;">
				平均分：<input name="eeEmpEvaluations[0].average" type="text" id="zzAverage" value="${evaluationBean2.average}" readonly="readonly" style="width: 50px" class="input-mini"/>
			</label>
			</div><br>
	    </div>    
	    <div class="group-box">
	         ...
	         1. 请具体描述该组员在本年新的成长、成果.<br>
	         <textarea rows="2" cols="200" maxlength="1000" name="eeEmpEvaluations[1].describe1" style="width:500px;">${evaluationBean3.describe1 }</textarea><br>
	         2. 请具体描述该组员在本年做的不足的地方.<br>
	         <textarea rows="2" cols="200" maxlength="1000" name="eeEmpEvaluations[1].describe2" style="width:500px;">${evaluationBean3.describe2 }</textarea><br>
	         3.请描述该组员在业务上的长处、特点以及可能性.<br>
	         <textarea rows="2" cols="200" maxlength="1000" name="eeEmpEvaluations[1].describe3" style="width:500px;">${evaluationBean3.describe3 }</textarea><br>
	         4. 请描述该组员在工作上的短处以及问题点. <br>
	         <textarea rows="2" cols="200" maxlength="1000" name="eeEmpEvaluations[1].describe4" style="width:500px;">${evaluationBean3.describe4 }</textarea><br>
	         5.组员业务成绩评价表.10分制: A—不良； B—不足； C—普通； D—良好； E—优秀。请选择：
			<table id="tableHead" style="width:100%" class="table table-striped table-bordered table-condensed" >
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td><input type="hidden" name="eeEmpEvaluations[1].evaluateType" value="3" />
						<input type="hidden" name="eeEmpEvaluations[1].id" value="${evaluationBean3.id }" />
							<select name="eeEmpEvaluations[1].evaluate1" class="jlEvaluate" style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>工作质量</td><td>工作完成的精准度,工作成果的质量是否优秀</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate2" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>业务知识</td><td>是否清楚本人所要做的工作内容以及为什么要做?</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate3" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>工作责任感</td><td>对自身工作是否有较高的责任感?对新附加的责任是否积极、勇于担当？</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate4" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>工作信任度</td><td>是否值得信任，是否能扎实地完成本人的工作任务</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate5" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>创意力</td><td>在工作的同时是否会主动思考更好的工作方法，和有创意性的改善工作的方法</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate6" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>协作精神</td><td>对于同事的请求乐于帮助、解决，与其他同事相互配合默契</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate7" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
					...
					<tr>
						<td>考勤情况</td><td>无迟到早退现象，工作时间集中度高</td>
						<td>
							<select name="eeEmpEvaluations[1].evaluate8" class="jlEvaluate"  style="width: 100px;">
								<option value=""></option>
								<c:forEach items="${fns:getDictList('DM0056')}" var="dictList">
			...
			<label style="float: right;">
				平均分：<input name="eeEmpEvaluations[1].average" type="text" id="jlAverage" value="${evaluationBean3.average}" readonly="readonly" style="width: 50px" class="input-mini"/>
			</label>
			</div><BR>
	    </div>  
	 </c:if>   
