...
<body>
    ...
    <ul class="ul-form">
		<li><label style="display: inline-block;width: 80px;">业务评价：</label>
			<input name="year" type="text" id="year" value="${eeNonsaleEmp.year }" readonly="readonly" style="width: 100px"
			 class="input-mini required Wdate"/>
		</li>
		<li><label style="display: inline-block;width: 80px;">工作计划：</label>
			<input name="nextYear" id="nextYear" type="text" value="${eeNonsaleEmp.year+1 }" readonly="readonly" style="width: 100px" class="input-mini required"/>
		</li>
    ...
    <div class="group-box">
 	...
 	<c:if test="${eeNonsaleEmp.workflowStatus != 50}">
	    <div class="group-box">
	         <div class="group-header" >
	         ...
	         <textarea rows="2" maxlength="500" name="eeEmpEvaluations[0].describe1" cols="200" style="width:500px;">${evaluationBean2.describe1 }</textarea><br>
	         2. 请具体描述该组员在本年做的不足的地方.<br>
	         <textarea rows="2" maxlength="500" name="eeEmpEvaluations[0].describe2" cols="200" style="width:500px;">${evaluationBean2.describe2 }</textarea><br>
	         3.请描述该组员在业务上的长处、特点以及可能性.<br>
	         <textarea rows="2" maxlength="500" name="eeEmpEvaluations[0].describe3" cols="200" style="width:500px;">${evaluationBean2.describe3 }</textarea><br>
	         4. 请描述该组员在工作上的短处以及问题点. <br>
	         <textarea rows="2" maxlength="500" name="eeEmpEvaluations[0].describe4" cols="200" <%-- readonly="${viewsts.canEdit ? true:false}"  --%>style="width:500px;">${evaluationBean2.describe4 }</textarea><br>
