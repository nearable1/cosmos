...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div style="float:right">
			<label class="control-label">区域语言:</label>
			<div class="controls">
				<form:select path="localeId" class="input-medium" onchange="localeChange()">
					<form:options items="${fns:getDictList('sys_locale')}" itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
			</div>
		</div><br/>
		...
		<div class="control-group">
			<label class="control-label">有效期间:</label>
			<div class="controls">
				<form:input path="startDate" name="startDate" type="text" readonly="readonly" maxlength="20" class="Wdate required"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
				-
				<form:input path="endDate" name="endDate" type="text" readonly="readonly" maxlength="20" class="Wdate required"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
