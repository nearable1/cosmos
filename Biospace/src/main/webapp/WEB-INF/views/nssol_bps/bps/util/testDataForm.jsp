...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bps/util/testData/">增删改查成功列表</a></li>
		<li class="active"><a href="${ctx}/bps/util/testData/form?id=${testData.id}">增删改查成功<shiro:hasPermission name="bps:util:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bps:util:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/bps/util/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="bps:util:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
