...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/bps/util/testData/">增删改查成功列表</a></li>
		<shiro:hasPermission name="bps:util:testData:edit"><li><a href="${ctx}/bps/util/testData/form">增删改查成功添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/bps/util/testData/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				<td><a href="${ctx}/bps/util/testData/form?id=${testData.id}">
					${testData.user.name}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="bps:util:testData:edit"><td>
    				<a href="${ctx}/bps/util/testData/form?id=${testData.id}">修改</a>
					<a href="${ctx}/bps/util/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该增删改查成功吗？', this.href)">删除</a>
