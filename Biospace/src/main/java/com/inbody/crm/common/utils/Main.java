...
public class Main {
    ...
    public static String myEmailAccount = "test@inbodychina.com";
    public static String myEmailPassword = "InBody0.";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1142378531@qq.com";
    ...
    public static void main(String[] args) throws Exception {
       ...
       // props.setProperty("mail.transport.protocol", "smtp");   // 使用的协议（JavaMail规范要求）
        ...
        transport.connect("smtp.partner.outlook.cn",myEmailAccount, myEmailPassword);
