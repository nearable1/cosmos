...
public class SmWarehouseInfo extends DataEntity<SmWarehouseInfo> {
    ...
    private String quotaDtlId;   // 占用库存的报价单明细行id
    ...
    @Length(min = 1, max = 15, message = "出入库履历编号 : 长度必须介于 1 和 15 之间")
    ...
    public String getQuotaDtlId() {
        return quotaDtlId;
    }

    public void setQuotaDtlId(String quotaDtlId) {
