 ...
 * @version 2017-08-30
 */
public class StSalesTargetCompareOrganizeExcel {
	...
	@ExcelField(title="组别", type=1, align=2, sort=1)
	...
	@ExcelField(title="税前/后", type=1, align=2, sort=2)
	...
	@ExcelField(title="1月", type=1, align=2, sort=3)
	...
	@ExcelField(title="2月", type=1, align=2, sort=4)
	...
	@ExcelField(title="3月", type=1, align=2, sort=5)
	...
	@ExcelField(title="4月", type=1, align=2, sort=6)
	...
	@ExcelField(title="5月", type=1, align=2, sort=7)
	...
	@ExcelField(title="6月", type=1, align=2, sort=8)
	...
	@ExcelField(title="7月", type=1, align=2, sort=9)
	...
	@ExcelField(title="8月", type=1, align=2, sort=10)
	...
	@ExcelField(title="9月", type=1, align=2, sort=11)
	...
	@ExcelField(title="10月", type=1, align=2, sort=12)
	...
	@ExcelField(title="11月", type=1, align=2, sort=13)
	...
	@ExcelField(title="12月", type=1, align=2, sort=14)
	...
	@ExcelField(title="合计", type=1, align=2, sort=15)
	...
	@ExcelField(title="已发货未开票", type=1, align=2, sort=16)
	...
	@ExcelField(title="未发货未开票", type=1, align=2, sort=17)
	...
	@ExcelField(title="实际完成", type=1, align=2, sort=18)
	...
	@ExcelField(title="目标", type=1, align=2, sort=19)
	...
	@ExcelField(title="佣金", type=1, align=2, sort=20)
	...
	@ExcelField(title="实际完成率", type=1, align=2, sort=21)
	...
	@ExcelField(title="完成率", type=1, align=2, sort=22)
	...
	@ExcelField(title="", mergedRegion=true, rows=2, firstCol=0, lastCol=0, type=1, align=2, sort=23)
