 ...
 * @version 2017-09-01
 */
public class SoRmRepairInfo extends DataEntity<SoRmRepairInfo> {
	...
	private String responsiblePersonName;		// 负责人名
	
	public SoRmRepairInfo() {
		super();
	}

	public SoRmRepairInfo(String id){
		super(id);
	}
