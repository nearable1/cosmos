package com.inbody.crm.sd.actionListener;
 ...
 *
 */
public class SdApproveMailSendListener implements TaskListener {
...
//		String[] roleEnnames = new String[3];
		String[] roleEnnames = new String[4];
		
		// 发货申请
		if(StringUtils.equals(workflowKey, "apply_deliver")){
			roleEnnames[0] = "crm-05";//工程部部长
			roleEnnames[1] = "crm_25";//生产部部长
			roleEnnames[2] = "crm_28";//物流组组长
			roleEnnames[3] = "crm_29";//物流组组员
//			roleEnnames[1] = "crm-08";//工程部-检测组长
//			roleEnnames[2] = "crm-09";//工程部-检测组员
		}
