...
public class ImInvoiceDtl extends DataEntity<ImInvoiceDtl> {
	...
	private String workflowStatus;		// 开票状态 : 代码
	...
	@Length(min=1, max=2, message="发票来源 : 代码长度必须介于 0 和 5 之间")
	...
	@Length(min=1, max=2, message="开票类型 : 代码长度必须介于 0 和 5 之间")
