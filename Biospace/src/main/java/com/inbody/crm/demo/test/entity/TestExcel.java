 ...
 */
package com.inbody.crm.demo.test.entity;
...
public class TestExcel extends DataEntity<Test> {
	...
	public TestExcel(String id){
		super(id);
	}

	@SupCol(text="登录名", sort = 20, minWidth="125px")
	@ExcelField(title="登录名", type=0, align=2, sort=1)
	...
	@ExcelField(title="创建时间", type=1, align=2, sort=3)
