 ...
 */
package com.inbody.crm.modules.oa.web;
...
import com.inbody.crm.modules.oa.service.OaNotifyService;
	...
	public String form(OaNotify oaNotify, Model model) {
		if (StringUtils.isNotBlank(oaNotify.getId())){
			...
			if (StringUtils.equals(oaNotify.getType(), "5")) {
				return "redirect:" + adminPath + "/rm/consulting/form?id=" + oaNotify.getTitle();
			}
		}
