...
import com.inbody.crm.modules.sys.security.FormAuthenticationFilter;
...
//		try {
//			byte[] bytes = com.inbody.crm.common.utils.FileUtils.readFileToByteArray(
//					com.inbody.crm.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
