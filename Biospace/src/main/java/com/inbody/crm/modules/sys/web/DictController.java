...
public class DictController extends BaseController {
	...
	public List<Dict> listChildData(@RequestParam(required=false) String parentId,String type) {
		Dict dict = new Dict();
		dict.setType(type);
	...
	@ResponseBody
	@RequestMapping(value = "loadBussinessOp")
	public List<BoBusinessOpp> loadBussinessOp(@RequestParam(required=false) String parentId) {
		BoBusinessOpp bean = new BoBusinessOpp();
		bean.setEndCustomerId(parentId);
		return boBusinessOppService.findListByCustomer(bean);
	}
}
