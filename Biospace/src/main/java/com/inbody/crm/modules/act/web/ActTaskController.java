 ...
 */
package com.inbody.crm.modules.act.web;
...
public class ActTaskController extends BaseController {
	...
	public String histoicFlow(Act act, String startAct, String endAct, Model model){
		if (StringUtils.isNotBlank(act.getProcInsId())){
			...
			List<Act> histoicFlowList = actTaskService.historicFlowList(act.getProcInsId());
	 ...
	 * @param endAct 结束活动节点名称
	 */
	@RequestMapping(value = "histoicFlowShow")
	public String histoicFlowShow(Act act, String startAct, String endAct, Model model){
		model.addAttribute("act",act);
		return "modules/act/actTaskHistoricFlowShow";
	}
	...
	public String form(Act act, HttpServletRequest request, Model model){
		...
		if (act.getProcInsId() != null){
			...
			if (actTaskService.getProcIns(act.getProcInsId()) != null) {
				...
				act.setProcHistoricIns(actTaskService.getProcHistoryIns(act.getProcInsId()));
			}
		}
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.inbody.crm.modules.act.utils.PropertyType
	 */
