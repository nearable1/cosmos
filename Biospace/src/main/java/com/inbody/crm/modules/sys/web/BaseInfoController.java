 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/base/index")
public class BaseInfoController extends BaseController {
	...
	@RequiresPermissions("sys:base:view")
	@RequestMapping(value = {"list", ""})
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findUser(new Page<User>(request, response), user);
        model.addAttribute("page", page);
		return "modules/sys/baseInfoIndex";
	}
	...
	public String listInfo(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findUser(new Page<User>(request, response), user);
        model.addAttribute("page", page);
		return "modules/sys/baseInfoList";
	}
