...
public class BusinessConstants {
    ...
    public final static String VIDEO_PYX_COLLECTION_NAME = Video_pyx.class.getSimpleName().toLowerCase();
     ...
     * 音频MongoDB集合名称
     */
    public final static String AUDIO_COLLECTION_NAME = Audio.class.getSimpleName().toLowerCase();
     ...
     * 视频审核MongoDB集合名称
     */
    public final static String VIDEO_PYX_REVIEW_COLLECTION_NAME = "video_pyx_review";
