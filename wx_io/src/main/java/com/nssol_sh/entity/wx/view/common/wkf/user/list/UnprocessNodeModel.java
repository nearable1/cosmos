 ...
 *
 */
public class UnprocessNodeModel {
	/**
	 * 用户编码.
	 */
	 ...
	 * 自动处理期限.
	 */
	public String autoProcessLimitDate;
	...
	/**
	 * @return the autoProcessLimitDate
	 */
	public String getAutoProcessLimitDate() {
		return autoProcessLimitDate;
	}
	...
	/**
	 * @return the pressLimitDate
	 */
	public String getPressLimitDate() {
		return pressLimitDate;
	}
	...
	/**
	 * @return the processAuth
	 */
	public String getProcessAuth() {
		return processAuth;
	}
