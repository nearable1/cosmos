 ...
 *
 */
public class Exp0401RailwayTicketModel {
	 ...
	 * 支付方式
	 */
	public String ticketSettlPayWay;

	/**
	 * 支付方式名称
	 */
	public String ticketSettlPayWayName;
	 ...
	 * 预算金额（人民币）.
	 */
	public BigDecimal ticketAmountRMB;
	 ...
	 * 发票号码
	 */
	public String ticketInvoice;

	/**
	 * @return the ticketInvoice
	 */
	public String getTicketInvoice() {
	 ...
	 */
	public BigDecimal getTicketAmountRMB() {
	...
	/**
	 * @return the ticketSettlPayWay
	 */
	public String getTicketSettlPayWay() {
		return ticketSettlPayWay;
	}

	/**
	 * @return the ticketSettlPayWayName
	 */
	public String getTicketSettlPayWayName() {
		return ticketSettlPayWayName;
	}
