package com.nssol_sh.service.wx.view.ysz.yexp.exp0301;
...
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301AccountingDetailRowModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301AccountingHeadModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301ApproveViewModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301FlightTicketModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301HotelModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301RailwayTicketModel;
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0301.Exp0301ScheduleModel;
import com.nssol_sh.service.wx.view.common.approveview.ApproveViewCommonService;

@Service("wx.veiw.ysz.yexp.exp0301.service")
		...
		if (model.matterUserInfo != null) {
			...
			if (model.matterUserInfo.flightTicketDtoList != null
				...
				for (Exp0301FlightTicketModel ftm : model.matterUserInfo.flightTicketDtoList) {
					...
					// 个人喜好
					ftm.preferName = this.getNameFromList(ftm.prefer, ftm.preferList);
