package com.nssol_sh.service.wx.view.yci.yexp.exp1201;
...
import com.nssol_sh.entity.wx.view.yci.yexp.exp1201.Exp1201AccountingDetailRowModel;
import com.nssol_sh.entity.wx.view.yci.yexp.exp1201.Exp1201AccountingHeadModel;
import com.nssol_sh.entity.wx.view.yci.yexp.exp1201.Exp1201ApproveViewModel;
import com.nssol_sh.service.wx.view.common.approveview.ApproveViewCommonService;

@Service("wx.veiw.yci.yexp.exp1201.service")
public class ApproveviewService extends ApproveViewCommonService {
	...
	public Exp1201ApproveViewModel forMatterData(Exp1201ApproveViewModel info) throws Exception {
		...
		if (info.matterUserInfo != null) {
			 ...
			 * 公司名称
			 */
			info.matterUserInfo.companyName = this.getNameFromList(info.matterUserInfo.companyCd,
					info.matterUserInfo.getCompanyList());
			/**
			 * 支付方式
			 */
