package com.nssol_sh.controller.wx.view.ysz.yexp.exp0401;
...
import com.nssol_sh.service.wx.view.ysz.yexp.exp0401.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysz.yexp.exp0401.controller")
@RequestMapping("/wx/view/ysz/yexp/exp0401")
public class ApproveViewController {
	 ...
	 * 跳转页面
	 */
	private static final String TURN_TO_PAGE = "/wx/ysz/yexp/exp0401/approveview";
