 ...
 * 
 */
package com.nssol_sh.controller.wx.view.yci.yexp.exp0701;
...
import com.nssol_sh.entity.wx.view.yci.yexp.exp0701.Exp0701ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.yci.yexp.exp0701.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.yci.yexp.exp0701.controller")
@RequestMapping("/wx/view/yci/yexp/exp0701")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/yci/yexp/exp0701/approveview";
	...
	public String approveView(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 请求路径
		String strUri = _routeAnaliyzerService.getApproveViewURL(ProgramConstant.PG_ID_YEXP_0701, rcrm.rpm.sf,
				rcrm.rpm.tenantid);

		// 调用API
		Exp0701ApproveViewModel result = _service.getData(postBody, strUri);
