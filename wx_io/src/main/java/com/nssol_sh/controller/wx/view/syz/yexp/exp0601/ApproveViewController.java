package com.nssol_sh.controller.wx.view.syz.yexp.exp0601;
...
import com.nssol_sh.entity.wx.view.syz.yexp.exp0601.Exp0601ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.syz.yexp.exp0601.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.syz.yexp.exp0601.controller")
@RequestMapping("/wx/view/syz/yexp/exp0601")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/syz/yexp/exp0601/approveview";
