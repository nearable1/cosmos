...
import com.nssol_sh.service.wx.view.cmn.wkf.process.ReserveService;
...
public class ReserveController {
	 ...
	 * @return 处理结果
	 */
	@RequestMapping(value = "/wx/view/cmn/wkf/process/reserve", produces = "application/json; charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
	public String reserve(@RequestParam(value = "usercd", required = true) String usercd,
