package com.nssol_sh.controller.wx.view.yci.yexp.exp0601;
...
import com.nssol_sh.entity.wx.view.yci.yexp.exp0601.Exp0601ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.yci.yexp.exp0601.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.yci.yexp.exp0601.controller")
@RequestMapping("/wx/view/yci/yexp/exp0601")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/yci/yexp/exp0601/approveview";
