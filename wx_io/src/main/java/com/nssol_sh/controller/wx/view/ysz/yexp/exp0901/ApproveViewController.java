package com.nssol_sh.controller.wx.view.ysz.yexp.exp0901;
...
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0901.Exp0901ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.ysz.yexp.exp0901.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysz.yexp.exp0901.controller")
@RequestMapping("/wx/view/ysz/yexp/exp0901")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/ysz/yexp/exp0901/approveview";
	...
	public String approveView(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 请求路径
		String strUri = _routeAnaliyzerService.getApproveViewURL(ProgramConstant.PG_ID_YEXP_0901, rcrm.rpm.sf,
				rcrm.rpm.tenantid);

		// 调用API
		Exp0901ApproveViewModel result = _service.getData(postBody, strUri);
