 ...
 * 
 */
package com.nssol_sh.controller.wx.view.ysw.yexp.exp0801;
...
import com.nssol_sh.entity.wx.view.ysw.yexp.exp0801.Exp0801ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.ysw.yexp.exp0801.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysw.yexp.exp0801.controller")
@RequestMapping("/wx/view/ysw/yexp/exp0801")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/ysw/yexp/exp0801/approveview";
