package com.nssol_sh.controller.wx.view.yci.yexp.exp0901;
...
import com.nssol_sh.service.wx.view.yci.yexp.exp0901.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.yci.yexp.exp0901.controller")
@RequestMapping("/wx/view/yci/yexp/exp0901")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/yci/yexp/exp0901/approveview";
