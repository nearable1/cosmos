 ...
 * 
 */
package com.nssol_sh.controller.wx.view.ysz.yexp.exp0801;
...
import com.nssol_sh.entity.wx.view.ysz.yexp.exp0801.Exp0801ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.ysz.yexp.exp0801.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysz.yexp.exp0801.controller")
@RequestMapping("/wx/view/ysz/yexp/exp0801")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/ysz/yexp/exp0801/approveview";
	...
	public String approveView(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 请求路径
		String strUri = _routeAnaliyzerService.getApproveViewURL(ProgramConstant.PG_ID_YEXP_0801, rcrm.rpm.sf,
				rcrm.rpm.tenantid);

		// 调用API
		Exp0801ApproveViewModel result = _service.getData(postBody, strUri);
