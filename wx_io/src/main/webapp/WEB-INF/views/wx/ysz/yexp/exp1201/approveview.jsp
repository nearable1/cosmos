...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/ysz/yexp/exp1201/approveview.js${JS_SUFFIX}"></script>
<script
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<!-- 申请者信息 End-->
			<!-- 02.基本信息 -->
			<div class="weui-cells__title" ins="ysz.yexp.exp1201.approveview"
				inm="commonMsg"></div>
			<div class="weui-cells_form weui-cells">
				<!-- 申请日 -->
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="ysz.yexp.exp1201.approveview"
							inm="applyDate"></label>
					</div>
							...
							<div class="wxio-record-content weui-cells">
								...
								<c:forEach items="${dto.detailRowModel}" var="detailRowModel">
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label debtorFlagName"
												ins="ysz.yexp.exp1201.approveview" inm="debtorFlag"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label accountingSubjectName"
												ins="ysz.yexp.exp1201.approveview" inm="expBroadCory"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label accountingSubjectName"
												ins="ysz.yexp.exp1201.approveview" inm="vaAccountingSubject"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
												value="${detailRowModel.accountingSubjectName}"
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label paymentAmountTaxIn"
												ins="ysz.yexp.exp1201.approveview" inm="paymentAmountTaxIn"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label taxRateList"
												ins="ysz.yexp.exp1201.approveview" inm="taxRate"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
									...
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label paymentAmountTaxOut"
												ins="ysz.yexp.exp1201.approveview" inm="paymentAmountTaxOut"></label>
										</div>
										<div class="label_td">
											<input class="weui-input wxio_input_class"
