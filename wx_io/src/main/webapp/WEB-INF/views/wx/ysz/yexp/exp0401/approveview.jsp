...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/ysz/yexp/exp0401/approveview.js${JS_SUFFIX}"></script>
<script
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<!-- 02.基本信息 -->
			<div class="weui-cells__title" ins="ysz.yexp.exp0401.approveview"
				inm="commonMsg"></div>
			<div class="weui-cells weui-cells__form">
				<!-- 申请日  -->
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="ysz.yexp.exp0401.approveview"
							inm="applyDate"></label>
					</div>
				...
				<c:forEach
					...
					<div class="wxio-record">
						...
						<div class="weui-cells wxio-record-content">
							...
							<c:if
								test="${requestScope.pageData.matterUserInfo.overseasFlag == 'OFFSHORE_TYPE_001' || requestScope.pageData.matterUserInfo.overseasFlag == 'OFFSHORE_LOCAL_TYPE_001'}">
								<!-- 出差距离 -->
								<div class="weui-cell">
									<div class="weui-cell__hd">
										<label class="weui-label" ins="ysz.yexp.exp0401.approveview"
						...
						<div class="wxio-record">
							...
							<div class="weui-cells wxio-record-content">
                                ...
                                <div class="weui-cell">
                                    <div class="weui-cell__hd">
                                        <label class="weui-label" ins="ysz.yexp.exp0401.approveview"
                                            inm="railwayTicketTicketQuantity"></label>
                                    </div>
                                    <div class="weui-cell__bd">
                                        <input class="weui-input" value="${dto.ticketQuantity}"
                                            readonly="readonly" style="color: grey;" />
                                    </div>
                                </div>
								<div class="weui-cell">
                                ...
                                <div class="weui-cell">
                                    <div class="weui-cell__hd">
                                        <label class="weui-label" ins="ysz.yexp.exp0401.approveview"
                                            inm="ticketInvoice"></label>
                                    </div>
                                    <div class="weui-cell__bd">
                                        <input class="weui-input" value="${dto.ticketInvoice}"
                                            readonly="readonly" style="color: grey;" />
                                    </div>
                                </div>
                                <!-- 支付方式 -->
			...
			<div class="weui-cells__form weui-cells">
				<c:forEach
					...
					<div class="weui-cell">
						<div class="weui-cell__bd">
                            <span class="weui-input wxio_input_class" ins="ysz.yexp.exp0401.approveview" inm="dayAllowance"></span><span class="wxio_input_class">${dto.subtotal}${dto.currencyName}（${dto.subtotalLocalCurrency}${requestScope.pageData.matterUserInfo.localCurrencyName}）</span>
						</div>
					</div>
				</c:forEach>
			</div>
