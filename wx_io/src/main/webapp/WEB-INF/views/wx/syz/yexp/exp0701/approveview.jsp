...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/syz/yexp/exp0701/approveview.js${JS_SUFFIX}"></script>
<script
	src="${RESOURCE_PATH}/js/i18n/wx/syz/yexp/common/applyUserInfo.js${JS_SUFFIX}"></script>
<style type="text/css">
.label_th {
	text-align: center;
	color: #888;
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<!-- 申请者信息 End-->
			<!-- 02.基本信息 -->
			<div class="weui-cells__title" ins="syz.yexp.exp0701.approveview"
				inm="commonMsg"></div>
			<div class="weui-cells__form weui-cells">
				<!-- 申请日 -->
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="syz.yexp.exp0701.approveview"
							inm="applyDate"></label>
					</div>
						...
						<c:choose>
							<c:when
								...
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="relationWithUs1">
								<p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.relationWithUs == '1'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="relationWithUs2">
								<p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.relationWithUs == '2'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="relationWithUs3"></p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.relationWithUs == '4'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="relationWithUs4">
								<p>
							</c:when>
						</c:choose>
					</div>
			...
			<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="syz.yexp.exp0701.approveview"
							inm="applicationsTimes"></label>
					</div>
					<div class="weui-cell__bd">
						<input class="weui-input wxio_input_class"
							value="${requestScope.pageData.matterUserInfo.applicationsTimes}"
							readonly="readonly" />
					</div>
			</div>
				<!-- 目的 -->
					...
					<div class="weui-cell__bd">
						...
						<c:choose>
							<c:when
								...
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="purpose1"></p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.purpose == '1'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="purpose2">
								<p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.purpose == '2'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="purpose3">
								<p>
							</c:when>
							<c:when
								test="${requestScope.pageData.matterUserInfo.purpose == '3'}">
								<p class="weui-input wxio_input_class"
									ins="syz.yexp.exp0701.approveview" inm="purpose4">
								<p>
							</c:when>
						</c:choose>
					</div>
