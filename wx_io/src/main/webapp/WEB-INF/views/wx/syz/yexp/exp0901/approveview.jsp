...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/syz/yexp/exp0901/approveview.js"></script>
<script
	src="${RESOURCE_PATH}/js/i18n/wx/syz/yexp/common/applyUserInfo.js"></script>
<style type="text/css">
.label_th {
	text-align: center;
	color: #888;
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<!-- 02.印章申请信息 -->
			<!-- 印章种类 -->
			<div class="weui-cells__title" ins="syz.yexp.exp0901.approveview"
				inm="stampsType"></div>
			<div class="weui-cells weui-cells_form">
					...
					<div class="wxio-record">
						<a class="weui-cell weui-cell_access" href="javascript:;">
							<div class="weui-cell__bd">
								<p class="weui-label-0901" ins="syz.yexp.exp0901.approveview"
									inm="stamps_2"></p>
							</div>
						...
						<div class="weui-cells wxio-record-content">
							<c:forEach
								items="${requestScope.pageData.matterUserInfo.stampListSYZ}"
								var="stampList">
								<c:if test="${stampList.checked.equals(true)}">
									<div class="weui-cell">
										<div class="label_th">
											<label class="weui-label" ins="syz.yexp.exp0901.approveview"
				...
				<c:if test="${requestScope.pageData.matterUserInfo.viewFlag03}">
					<div class="wxio-record">
						...
						<div class="weui-cells wxio-record-content">
							<c:forEach
								items="${requestScope.pageData.matterUserInfo.stampListSYT}"
								var="stampList">
								<c:if test="${stampList.checked.equals(true)}">
									<div class="weui-cell">
										<div class="label_th">
				...
				<c:if test="${requestScope.pageData.matterUserInfo.viewFlag01}">
					<div class="wxio-record">
						...
						<div class="weui-cells wxio-record-content">
							<c:forEach
								items="${requestScope.pageData.matterUserInfo.stampListBO}"
								var="stampList">
								<c:if test="${stampList.checked.equals(true)}">
									<div class="weui-cell">
										<div class="label_th">
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label-0901" ins="syz.yexp.exp0901.approveview"
							inm="fileCd"></label>
					</div>
					<div class="weui-cell__bd">
