...
<html lang="zh-cmn-Hans">
    <head>
        ...
        <script src="${RESOURCE_PATH}/js/i18n/wx/ysw/yexp/exp0601/approveview.js"></script>
        <script src="${RESOURCE_PATH}/js/i18n/wx/ysw/yexp/common/applyUserInfo.js"></script>
        <style type="text/css">
            .label_th {
                text-align: center;
                color:#888;
    ...
    <body ontouchstart>
     ...
     <div class="page">
		...
		<!-- 02.基本信息 -->	
			<div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="basicInfoTitle"></div>
			<div class="weui-cells weui-cells_form">
			    <!-- 申請日 -->
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="applyDate"></label>
                        </div>
                ...
                <!-- 項目代碼 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="projectCd"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <!-- 項目名-->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="projectName"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <!-- 項目負責人 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="pmName"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <!-- 公司名称 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="companyName"></label>
                        </div>
               ...
               <!-- 事业部 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="buName"></label>
                        </div>
               ...
               <!-- 部門 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="deptName"></label>
                        </div>
                ...
                <!-- 成本中心 -->    
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="costCenterName"></label>
                        </div>
        ...
        <!-- 03.交通费报销 -->
            <div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="TrafficReimbursement"></div>
            <div class="weui-cells weui-cells_form">
               <c:forEach items="${requestScope.pageData.matterUserInfo.transDtoList}" var="dto">
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="riqi"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TrafficStartTime"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TrafficEndTime"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TransportFrom"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TransportTo"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="thing"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="ticketPrice"></label>
                                </div>
                                <div class="weui-cell__bd">
                             ...
                             <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="InvoiceNumber"></label>
                                </div>
                                <div class="weui-cell__bd">
       ...
       <!-- 04.交通費報銷合計 -->     
         <div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="TrafficgetTotal"></div>
            <div class="weui-cells weui-cells_form"> 
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="budgetTotal"></label>
                        </div>
                        &nbsp;<div class="weui-cell__bd">
            ...
            <c:if test="${requestScope.pageData.matterUserInfo.accountingFlag == '1'}">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="accountingInfo1"></div>
                </c:when>
                <c:otherwise>
                <div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="accountingInfo2"></div>
                </c:otherwise>
                </c:choose>
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingDebtorFlagName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingExpBroadCategoryName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingExpSubCategoryName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingExpItemName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingSubjectName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingPaymentAmountTaxIn"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingTaxRate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingPaymentAmountTaxOut"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingTaxAmount"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingCurrencyName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingExchangeRate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingCostCenterCd"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingInvoice"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingPartner"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="accountingSummary"></label>
                                </div>
                                <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0601.approveview" inm="payment"></div>
                <div class="weui-cells weui-cells_form">
                      <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TotalTax"></label>
                        </div>
                       &nbsp; <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="TotalCost"></label>
                        </div>
                       &nbsp; <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0601.approveview" inm="Totaltaxamount"></label>
                        </div>
                       &nbsp; <div class="weui-cell__bd">
