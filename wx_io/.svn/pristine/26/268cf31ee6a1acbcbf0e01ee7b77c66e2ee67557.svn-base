...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/ysw/yexp/exp0501/approveview.js${JS_SUFFIX}"></script>
<script
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<div class="weui-cells__title" ins="ysw.yexp.exp0501.approveview"
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="ysw.yexp.exp0501.approveview"
							inm="applyDate"></label>
					</div>
