 ...
 * 
 */
package com.nssol_sh.service.wx.view.syz.yexp.exp0701;
...
import com.nssol_sh.entity.wx.view.syz.yexp.exp0701.Exp0701AccountingDetailRowModel;
import com.nssol_sh.entity.wx.view.syz.yexp.exp0701.Exp0701AccountingHeadModel;
import com.nssol_sh.entity.wx.view.syz.yexp.exp0701.Exp0701ApproveViewModel;
import com.nssol_sh.entity.wx.view.syz.yexp.exp0701.Exp0701EntmDetailModel;
 ...
 *
 */
@Service("wx.veiw.syz.yexp.exp0701.service")
public class ApproveviewService extends ApproveViewCommonService {
	...
	private Exp0701ApproveViewModel formatViewData(Exp0701ApproveViewModel model) throws UnsupportedEncodingException {
		...
		if (model.matterUserInfo != null) {
			...
			// 第几次招待
			model.matterUserInfo.applicationsTimes = this.getNameFromList("",
					model.matterUserInfo.applicationsTimesList);
			// 业务招待费用明细
