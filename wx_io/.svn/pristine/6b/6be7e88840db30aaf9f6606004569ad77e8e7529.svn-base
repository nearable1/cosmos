package com.nssol_sh.entity.wx.view.ysz.yexp.exp0401;

import java.util.List;
import java.util.Map;

public class Exp0401MatterUserInfoModel {
	 ...
	 * 出張申請案件名
	 */
	public String imwExpApplyMatterName;
	 ...
	 * 出差日程一览.
	 */
	public List<Exp0401ScheduleModel> scheduleDtoList;
	 ...
	 * 住宿一览 .
	 */
	public List<Exp0401HotelModel> hotelDtoList;

	/**
	 * 有出差其他费用报销 （0：无、1：有）.
	 */
	public String otherExpenseRequiredFlag;

	/**
	 * 出差其他费用报销 一览 .
	 */
	public List<Exp0401OtherExpenseModel> otherExpenseDtoList;

	/**
	 * 补贴一览.
	 */
	public List<Exp0401AllowanceModel> allowanceDtoList;

	/**
	 * 借款金额一览（only 1 Item）.
	 */
	public List<Exp0401WriteOffAmountModel> writeOffDtoList;
	 ...
	 * 财务入力模块.
	 */
	public Exp0401AccountingCmmModel accountingCmmDto;

	/**
	 * 个人预订
	 */
	public boolean railwayTicketRequiredFlag;

	/**
	 * 个人预订一览.
	 */
	public List<Exp0401RailwayTicketModel> railwayTicketDtoList;

	/**
	 * 公司代订Flag
	 */
	public boolean ticketRequiredFlag;
	/**
	 * 公司代订一览.
	 */
	public List<Exp0401FlightTicketModel> flightTicketDtoList;
	 ...
	 */
	public List<Exp0401ScheduleModel> getScheduleDtoList() {
	 ...
	 */
	public List<Exp0401FlightTicketModel> getFlightTicketDtoList() {
	 ...
	 */
	public List<Exp0401RailwayTicketModel> getRailwayTicketDtoList() {
	 ...
	 */
	public List<Exp0401HotelModel> getHotelDtoList() {
		return hotelDtoList;
	}
	 ...
	 */
	public List<Exp0401AllowanceModel> getAllowanceDtoList() {
	 ...
	 */
	public Exp0401AccountingCmmModel getAccountingCmmDto() {
		return accountingCmmDto;
	}

	/**
	 * @return the writeOffDtoList
	 */
	public List<Exp0401WriteOffAmountModel> getWriteOffDtoList() {
		return writeOffDtoList;
	}
	...
	/**
	 * @return the otherExpenseRequiredFlag
	 */
	public String getOtherExpenseRequiredFlag() {
		return otherExpenseRequiredFlag;
	}

	/**
	 * @return the otherExpenseDtoList
	 */
	public List<Exp0401OtherExpenseModel> getOtherExpenseDtoList() {
		return otherExpenseDtoList;
	}
	...
	/**
	 * @return the railwayTicketRequiredFlag
	 */
	public boolean isRailwayTicketRequiredFlag() {
		return railwayTicketRequiredFlag;
	}

	/**
	 * @return the ticketRequiredFlag
	 */
	public boolean isTicketRequiredFlag() {
		return ticketRequiredFlag;
	}
	...
	/**
	 * @return the imwExpApplyMatterName
	 */
	public String getImwExpApplyMatterName() {
		return imwExpApplyMatterName;
	}
