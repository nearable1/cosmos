package com.nssol_sh.controller.wx.view.syz.yexp.exp1201;
...
import com.nssol_sh.service.wx.view.syz.yexp.exp1201.ApproveviewService;
import com.nssol_sh.util.constants.ProgramConstant;
import com.nssol_sh.util.tools.http.ResponseUtil;

@Controller("wx.view.syz.yexp.exp1201.controller")
@RequestMapping("/wx/view/syz/yexp/exp1201")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/syz/yexp/exp1201/approveview";
