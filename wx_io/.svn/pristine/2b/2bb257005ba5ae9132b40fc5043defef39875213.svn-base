package com.nssol_sh.service.wx.view.ysw.yexp.exp1201;
...
import com.nssol_sh.entity.wx.view.ysw.yexp.exp1201.Exp1201AccountingDetailRowModel;
import com.nssol_sh.entity.wx.view.ysw.yexp.exp1201.Exp1201AccountingHeadModel;
import com.nssol_sh.entity.wx.view.ysw.yexp.exp1201.Exp1201ApproveViewModel;
import com.nssol_sh.service.wx.view.common.approveview.ApproveViewCommonService;

@Service("wx.veiw.ysw.yexp.exp1201.service")
public class ApproveviewService extends ApproveViewCommonService {
	...
	public Exp1201ApproveViewModel forMatterData(Exp1201ApproveViewModel info) throws Exception {
		...
		if (info.matterUserInfo != null) {
			 ...
			 * 公司名称
			 */
			if (info.matterUserInfo.getCompanyList() != null && info.matterUserInfo.getCompanyList().size() > 0) {
				for (Map<String, Object> item : info.matterUserInfo.getCompanyList()) {
					if (item.get("selected") != null) {
						info.matterUserInfo.companyName = item.get("label") != null ? item.get("label").toString() : "";
					}
				}
			}
