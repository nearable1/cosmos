...
<html>
    <head>
        ...
        <script src="${RESOURCE_PATH}/js/i18n/wx/yci/yexp/swm008/approveview.js${JS_SUFFIX}"></script>
    ...
    <script type="text/html" id="tpl_home">
        <div class="page">
            ...
            <%@include file="/WEB-INF/views/wx/yci/yexp/common/applyUserInfo.jsp"%>
                <div class="weui-cells__title" ins="yci.yexp.swm008.approveview" inm="vacationInfoTitle"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label" ins="yci.yexp.swm008.approveview" inm="vacationType"></label></div>
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label" ins="yci.yexp.swm008.approveview" inm="startDate"></label></div>
                        <div class="weui-cell__bd">
                            ...
                            <lable ins="yci.yexp.swm008.approveview" inm="amMsg"></lable>
                            </c:if>
                            <c:if test="${requestScope.pageData.matterUserInfo.vacationStartPeriod == '02'}">
                            <lable ins="yci.yexp.swm008.approveview" inm="pmMsg"></lable>
                            </c:if>
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label" ins="yci.yexp.swm008.approveview" inm="endDate"></label></div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label" ins="yci.yexp.swm008.approveview" inm="emergencyContact"></label></div>
                        <div class="weui-cell__bd">
                            <input class="weui-input"  readonly="readonly" style="color:grey;" value="${requestScope.pageData.matterUserInfo.emergencyContact}">
                        </div>
                    </div>
                </div>
                <div class="weui-cells__title" ins="yci.yexp.swm008.approveview" inm="vacationReason"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
