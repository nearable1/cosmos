 ...
 * 
 */
package com.nssol_sh.controller.wx.view.yci.yexp.exp0801;
...
import com.nssol_sh.entity.wx.view.yci.yexp.exp0801.Exp0801ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.yci.yexp.exp0801.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.yci.yexp.exp0801.controller")
@RequestMapping("/wx/view/yci/yexp/exp0801")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/yci/yexp/exp0801/approveview";
