package com.nssol_sh.controller.wx.view.yci.yexp.exp1201;
...
import com.nssol_sh.service.wx.view.yci.yexp.exp1201.ApproveviewService;
import com.nssol_sh.util.constants.ProgramConstant;
import com.nssol_sh.util.tools.http.ResponseUtil;

@Controller("wx.view.yci.yexp.exp1201.controller")
@RequestMapping("/wx/view/yci/yexp/exp1201")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/yci/yexp/exp1201/approveview";
