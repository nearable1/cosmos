package com.nssol_sh.controller.wx.view.ysz.yexp.exp0601;
...
import com.nssol_sh.service.wx.view.ysz.yexp.exp0601.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysz.yexp.exp0601.controller")
@RequestMapping("/wx/view/ysz/yexp/exp0601")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/ysz/yexp/exp0601/approveview";
