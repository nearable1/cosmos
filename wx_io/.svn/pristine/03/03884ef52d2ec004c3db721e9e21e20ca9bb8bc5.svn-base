package com.nssol_sh.controller.wx.view.ysw.yexp.exp0401;
...
import com.nssol_sh.service.wx.view.ysw.yexp.exp0401.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.ysw.yexp.exp0401.controller")
@RequestMapping("/wx/view/ysw/yexp/exp0401")
public class ApproveViewController {
	 ...
	 * 跳转页面
	 */
	private static final String TURN_TO_PAGE = "/wx/ysw/yexp/exp0401/approveview";
