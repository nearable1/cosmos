...
<html lang="zh-cmn-Hans">
    <head>
        ...
        <script src="${RESOURCE_PATH}/js/i18n/wx/ysw/yexp/exp0301/approveview.js${JS_SUFFIX}"></script>
    ...
    <body ontouchstart>
        ...
        <div class="page">
            <div class="weui-tab__panel">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="basicInfoTitle"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="applyDate"></label>
                        </div>
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="companyName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="buName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="deptName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="costCenterName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="projectCd"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="projectName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="pmName"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="bizTripDuration"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="overseasFlagName"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="bizTripPurpose"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="borrowingAmountTitle"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="borrowingAmount"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="borrowingAmountCurrency"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="borrowingAmountPayMathod"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="borrowingAmountHopePayDate"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="bizTripSchedule"></div>
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="bizTripDivName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="schedulePlace"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="scheduleStartDate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="scheduleEndDate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="scheduleDays"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="subsidiesDays"></label>
                                </div>
                                <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="flightTicket">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketDepartDate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTransportTypeName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTicketNumber"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTrafficStartTime"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTrafficEndTime"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTransportFrom"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTransportTo"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTicketQuantity"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTicketPrice"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTicketAmount"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="flightTicketTicketCurrencyName"></label>
                                </div>
                                <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="railwayTicket">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="hotelRequired">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelDestinationDivName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelStartDate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelEndDate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelDays"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelPrice"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelAmount"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelCurrencyName"></label>
                                </div>
                                <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="allowance"></div>
                <div class="weui-cells weui-cells_form">
                    <c:forEach items="${requestScope.pageData.matterUserInfo.allowanceDtoList}" var="dto">
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <span class="weui-input wxio_input_class" ins="ysw.yexp.exp0301.approveview" inm="dayAllowance"></span><span class="wxio_input_class">${dto.subtotal}${dto.currencyName}（${dto.subtotalLocalCurrency}${requestScope.pageData.matterUserInfo.localCurrencyName}）</span>
                        </div>
                    </div>
                    </c:forEach>
                </div>
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="budgetSummary"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="ticketBudget"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="hotelBudget"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="allowanceBudget"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="budgetSubTotal"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="budgetTotal"></label>
                        </div>
                        <div class="weui-cell__bd">
                ...
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="accountingInfo1"></div>
                </c:when>
                <c:otherwise>
                <div class="weui-cells__title" ins="ysw.yexp.exp0301.approveview" inm="accountingInfo2"></div>
                </c:otherwise>
                </c:choose>
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="wxio-record">
                        ...
                        <div class="weui-cells wxio-record-content">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingDebtorFlagName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingExpBroadCategoryName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingExpSubCategoryName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingExpItemName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingSubjectName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingPaymentAmountTaxIn"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingTaxRate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingPaymentAmountTaxOut"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingTaxAmount"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingCurrencyName"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingExchangeRate"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingCostCenterCd"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingInvoice"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingPartner"></label>
                                </div>
                                <div class="weui-cell__bd">
                            ...
                            <div class="weui-cell">
                                <div class="weui-cell__hd">
                                    <label class="weui-label" ins="ysw.yexp.exp0301.approveview" inm="accountingSummary"></label>
                                </div>
                                <div class="weui-cell__bd">
