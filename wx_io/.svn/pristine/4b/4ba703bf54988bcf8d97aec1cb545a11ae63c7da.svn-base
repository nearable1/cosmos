package com.nssol_sh.controller.wx.view.syz.yexp.exp0501;
...
import com.nssol_sh.entity.wx.view.syz.yexp.exp0501.Exp0501ApproveViewModel;
import com.nssol_sh.service.wx.view.common.route.RouteAnaliyzerService;
import com.nssol_sh.service.wx.view.syz.yexp.exp0501.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.syz.yexp.exp0501.controller")
@RequestMapping("/wx/view/syz/yexp/exp0501")
public class ApproveViewController {
	 ...
	 * 跳转页面
	 */
	private static final String TURN_TO_PAGE = "/wx/syz/yexp/exp0501/approveview";
