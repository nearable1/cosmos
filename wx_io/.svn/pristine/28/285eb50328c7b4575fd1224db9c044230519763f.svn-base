 ...
 *
 */
public class Exp0401AccountingCmmModel {
	/**
	 * 希望支付日是否显示.
	 */
	 ...
	 * 会计科目一览
	 */
	public List<Exp0401AccountingHeadModel> accountingHeadList;
	 ...
	 */
	public List<Exp0401AccountingHeadModel> getAccountingHeadList() {
