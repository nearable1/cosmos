package com.nssol_sh.controller.wx.view.syz.yexp.exp0901;
...
import com.nssol_sh.service.wx.view.syz.yexp.exp0901.ApproveviewService;
 ...
 *
 */
@Controller("wx.view.syz.yexp.exp0901.controller")
@RequestMapping("/wx/view/syz/yexp/exp0901")
public class ApproveViewController {

	/**
	 * 跳转页面
	 */
	public static final String TURN_TO_PAGE = "/wx/syz/yexp/exp0901/approveview";
