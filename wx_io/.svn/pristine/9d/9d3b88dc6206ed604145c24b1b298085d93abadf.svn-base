...
<!-- 申请者信息 -->
<div class="weui-cells__title" ins="yci.yexp.common.expApplyUserInfo" inm="applyUserInfoTitle"></div>
<div class="weui-cells weui-cells_form">
	<!-- 申请者 -->
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label" ins="yci.yexp.common.expApplyUserInfo" inm="applyUser"></label>
        </div>
    ...
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label" ins="yci.yexp.common.expApplyUserInfo" inm="applyExecuteUserName"></label>
        </div>
        <div class="weui-cell__bd">
    ...
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label" ins="yci.yexp.common.expApplyUserInfo" inm="mainDepartmentCd"></label>
        </div>
        <div class="weui-cell__bd">
