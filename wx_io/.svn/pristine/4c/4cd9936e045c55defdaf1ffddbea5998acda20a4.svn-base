...
<script
	src="${RESOURCE_PATH}/js/i18n/wx/ysw/yexp/exp0401/approveview.js${JS_SUFFIX}"></script>
<script
...
<body ontouchstart>
	...
	<div class="page">
		<div class="weui-tab__panel">
			...
			<!-- 02.基本信息 -->
			<div class="weui-cells__title" ins="ysw.yexp.exp0401.approveview"
				inm="commonMsg"></div>
			<div class="weui-cells weui-cells__form">
				<!-- 申请日  -->
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label" ins="ysw.yexp.exp0401.approveview"
							inm="applyDate"></label>
					</div>
			...
			<div class="weui-cells__form weui-cells">
				<c:forEach
					...
					<div class="weui-cell">
						<div class="weui-cell__bd">
                            <span class="weui-input wxio_input_class" ins="ysw.yexp.exp0401.approveview" inm="dayAllowance"></span><span class="wxio_input_class">${dto.subtotal}${dto.currencyName}（${dto.subtotalLocalCurrency}${requestScope.pageData.matterUserInfo.localCurrencyName}）</span>
						</div>
					</div>
				</c:forEach>
			</div>
