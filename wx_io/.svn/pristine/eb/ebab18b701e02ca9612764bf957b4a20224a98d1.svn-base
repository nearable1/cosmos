...
<html>
    <head>
        ...
        <script src="${RESOURCE_PATH}/js/i18n/wx/yci/yexp/swm007/approveview.js${JS_SUFFIX}"></script>
    ...
    <body ontouchstart>
        ...
        <div class="page">
            <div class="weui-tab__panel">
                ...
                <div class="weui-cells__title" ins="yci.yexp.swm007.approveview" inm="overtimeInfoTitle"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                    <div class="weui-cell__hd">
                        <label class="weui-label" ins="yci.yexp.swm007.approveview" inm="overtimeType"></label>
                    </div>
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="yci.yexp.swm007.approveview" inm="overtimeDate"></label>
                        </div>
                        <div class="weui-cell__bd">
                            ...
                            <lable ins="yci.yexp.swm007.approveview" inm="amMsg"></lable>
                            </c:if>
                            <c:if test="${requestScope.pageData.matterUserInfo.overtimeStartPeriod == '02'}">
                            <lable ins="yci.yexp.swm007.approveview" inm="pmMsg"></lable>
                            </c:if>
                            ~
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <em ins="yci.yexp.swm007.approveview" inm="summaryMsg"></em>
                            ...
                            <em ins="yci.yexp.swm007.approveview" inm="dayMsg"></em>
                        </div>
                    </div>
                    </c:if>
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                            <label class="weui-label" ins="yci.yexp.swm007.approveview" inm="overtimeTime"></label>
                        </div>
                        <div class="weui-cell__bd">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            ...
                            <em ins="yci.yexp.swm007.approveview" inm="hourMsg"></em>
                        </div>
                    </div>
                    </c:if>
                </div>
                <div class="weui-cells__title" ins="yci.yexp.swm007.approveview" inm="overtimeReason"></div>
                <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
